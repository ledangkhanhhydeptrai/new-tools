...
def interruptible_sleep(seconds, quantum=0.10):
    """
    Sleep in short slices so Ctrl+C is observed quickly on Windows.
    KeyboardInterrupt is deliberately NOT swallowed.
    """
    try:
